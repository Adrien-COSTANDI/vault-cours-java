...
C'est notamment dans le JRE qu'on retrouve la fameuse **[[2. Fonctionnement de Java|JVM]]**.
...
C'est notamment dans le JDK qu'on retrouve le fameux **[[2. Fonctionnement de Java|compilateur]]**.
