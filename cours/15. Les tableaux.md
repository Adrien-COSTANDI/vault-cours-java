...
Les tableaux ne sont pas des types primitifs. Ils sont considérés comme des **[[14. Les objets (Partie 1)|objets]]**. Comme pout tous les types objets, pour initialiser la variable je dois utiliser le **mot clé** `{java}new`. 
...
Bon, les tableaux sont déjà sympas pour stocker des quantités de données, mais je fais comment si j'ai besoin d'un usage plus poussé ? Eh bien on fait comme tout le monde, on utilise [[17. Les collections|les collections]] !
