...
Ainsi, les [[9. Opérateurs|opérateurs]] servent à combiner des expressions pour en faire de nouvelles.
...
Par exemple, dans notre [[5. Hello World!|Hello World]] nous avons utilisé l'instruction `{java}IO.println("Hello World!")`. Cette instruction utilise une expression donnée entre les parenthèses pour l'afficher dans la console. Elle ne renvoie aucune valeur.
...
[[11. if, switch-case|Apprenons à utiliser des conditions !]]
