...
> [!info]
> Le `if` et ses compères sont des **[[10. Expression vs instruction (statement)#Instructions (statements)|instructions]]** et pas des **[[10. Expression vs instruction (statement)#Expressions|expressions]]**, ils ne renvoient pas de valeurs. Il n'est donc pas possible d'avoir quelque chose comme `{java}int a = if (...)`.
...
Passons au plat de résistance, [[12. for, while, do while|les boucles !]]
